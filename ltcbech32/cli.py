...
from ltcbech32.chain.fees import estimate_fee
from ltcbech32.config import WalletConfig
from ltcbech32.services.sync import SyncEngine
...
def portfolio() -> None:
    ...
    click.echo(f"coin=LTC total={total} fee_hint={fee}")
